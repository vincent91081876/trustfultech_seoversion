...
const faqs = [
  {
    question: "什麼是 ERP 企業資源規劃系統？導入有什麼好處？",
    answer: "ERP（企業資源規劃）系統整合進銷存、財務、生產與人資等核心流程，讓企業數據即時互通、減少人工作業與錯誤。我們提供 ERP 系統導入與客製化開發，依照您的產業特性與流程量身打造，幫助企業提升營運效率、降低成本。",
  },
  {
    question: "POS 銷售系統適合哪些產業？可以客製化嗎？",
    answer: "我們的 POS 銷售點管理系統適合零售、餐飲、門市連鎖等產業，支援門市結帳、庫存即時管理、會員與促銷活動，並整合線上線下銷售數據。系統可依您的營運需求客製化開發，從單店到多門市管理都能彈性支援。",
  },
  {
    question: "客製化平台開發的流程是什麼？需要多久時間？",
    answer: "客製化平台開發分為五個階段：1. 需求分析與規劃 2. UI/UX 設計 3. 系統開發 4. 測試驗收 5. 部署上線與維護。時程依專案規模而定，一般約 2-6 個月。我們提供一站式開發服務，從網站到應用平台都能量身打造。",
  },
  {
    question: "智信網路科技的服務範圍包括哪些？",
    answer: "我們提供九大核心服務：1. ERP 企業資源規劃 2. POS 銷售系統 3. 客製化平台開發 4. 傳直銷系統開發 5. AI 輔助軟體開發 6. 網站 SEO 優化 7. AI SEO 智能優化 8. GEO 生成式引擎優化 9. AEO 答案引擎優化。從系統開發到搜尋優化，提供一站式數位轉型解決方案。",
  },
  {
